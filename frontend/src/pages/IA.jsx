  ...
  return body.map((item, index) => {
    ...
    if (item.type === "heading") {
      return (
        <p
          key={key}
          className={`ia-card-text ia-card-heading ia-card-heading-${variant}`}
        >
          {item.text}
        </p>
      );
  ...
  return (
    <div style={pageStyle}>
      <section style={headerStyle}>
        ...
        <h1 style={titleStyle}>IA con ética, transparencia y evolución continua</h1>
        <p style={subtitleStyle}>
          Descubre los principios que guían el uso responsable de IA en TRÓPICA, accede al catálogo de
          licencias aprobadas y activa las automatizaciones que impulsan nuestro trabajo diario.
        </p>
      </section>
      ...
      <section style={gridWrapperStyle}>
        <div className="ia-section-header">
          <h2>Licencias aprobadas</h2>
          <p>
            Consulta las herramientas avaladas por TRÓPICA y revisa sus condiciones de uso, sub-herramientas y
            recomendaciones.
          </p>
        </div>
        <Licenses />
      ...
      <section style={gridWrapperStyle}>
        <div className="ia-section-header">
          ...
          <p>
            Dispara flujos confiables para proyectos clave y mantén la trazabilidad de cada automatización que
            integre IA en nuestros procesos.
          </p>
        </div>
        <Automations />
      </section>
